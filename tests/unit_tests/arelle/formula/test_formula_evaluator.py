...
@dataclass
class DummyVariableBinding:
    aspectsDefined: set
    aspectsCovered: set = field(default_factory=set)
...
def test_fact_variable_evaluation_results_do_not_yield_fallback_when_facts_exist() -> None:
